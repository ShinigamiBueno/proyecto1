...
<?php
$sql= $mysqli->query("SELECT * FROM requisicion_compras WHERE bandera=0");
 $row=$sql->num_rows;
          ...
          <th width="300">
            <div class="form-group">
              <label>Número de Solicitud</label>
                <input type="text" class="form-control" name="numero_solicitud" value="<?php echo $rows ?>" placeholder="Ingrece No de Solicitud">
            </div>
            <div class="form-group">
              <label>Fecha de Formulación</label>
                <input type="date" class="form-control" name="requisicion_fecha_formulacion" placeholder="Ingrece Fecha de Formulación">
            </div>            
            <div class="form-group">
              <label>Fecha de Requerimiento</label>
              <input type="date" class="form-control" name="fecha_requerimiento"  placeholder="Ingrece Fecha de Requerimiento">
            </div>
         </th>
         <th width="200"></th>
         <th width="300">
