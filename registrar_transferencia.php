<?php
    ...
    //Toda la información
  if ($insert_stmt = $mysqli->prepare("INSERT INTO cuentas_fiscales(idcuentas_fiscales,idempresa,fecha,concepto,referencia_obervacion,monto,iot,numero_folio) VALUES (?,?,?,?,?,?,?,?)")) {
    $insert_stmt->bind_param('iissssss', $idcuentas_fiscales,$idempresa,$fecha,$concepto,$referencia_obervacion,$monto,$iot,$numero_folio);
