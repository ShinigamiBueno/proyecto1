   ...
   <table class="table" border="">
    <thead>
     <center>
      ...
      <div class="row">
        <table>
         <form class="col-xs-5" action="pruebaB.php" method="post" accept-charset="   UTF-8">
          <th width="300">
           <div class="form-group">
            <label>Número de Solicitud</label>
            <input class="form-control" type="text" id="requisicion_obra_No_solicitud" name="requisicion_obra_No_solicitud" placeholder="Ingrese No de Solicitud">	
           </div>
           <div class="form-group">
         ...
         <th width="300">
           <div class="=form-group">
           	...
           	<input class="form-control" type="time" id="requisicion_hora_requerimiento_obra" name="requisicion_hora_requerimiento_obra">
           </div>
           <div class="form-group">
